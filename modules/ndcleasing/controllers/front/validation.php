 ...
 * @since 1.5.0
 */
class ndcleasingValidationModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        ...
        if (!$authorized) {
            die($this->trans('This payment method is not available.', array(), 'Modules.ndcleasing.Shop'));
        }
        ...
        $mailVars =    array(
            ...
            '{check_address_html}' => str_replace("\n", '<br />', Configuration::get('LEASING_ADDRESS')));

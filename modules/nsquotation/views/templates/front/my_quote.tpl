...
<input type="text" name="product_qty" pattern="[00-9999]" value="{if isset($smarty.post.product_qty)}{$smarty.post.product_qty}{else}1{/if}">
</td>
<td class="cart_product_fees fees-class totalplus">
...
<td class="cart_product_fees fees-class totalplus">
<input type="text" name="product_qty" pattern="[00-9999]" value="{if isset($smarty.post.product_qty)}{$smarty.post.product_qty}{else}{QuotationProduct::getQtyId($id_product,$id_ns_quotation)}{/if}">
</td>
<td class="cart_product_fees fees-class totalplus">
 {Tools::displayPrice($product->price, $currency)}
</td>			

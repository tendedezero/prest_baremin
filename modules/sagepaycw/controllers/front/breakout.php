 ...
 *
 */
class SagePayCwBreakOutModuleFrontController extends ModuleFrontController {
	public $ssl = true;
	...
	public function initContent(){
		...
		$dbTransaction = SagePayCw_Entity_Transaction::loadById($id_transaction);
		...
		$this->setTemplate('module:sagepaycw/views/templates/front/breakout.tpl');
	}
}

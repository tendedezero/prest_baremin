...
class SagePayCwRedirectionModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
...
require_once 'SagePayCw/Entity/Transaction.php';
		...
		$dbTransaction = SagePayCw_Entity_Transaction::loadById(intval($_GET['cw_transaction_id']));
		...
		$authorizationAdapter = SagePayCw_Util::getAuthorizationAdapter($dbTransaction->getTransactionObject()->getAuthorizationMethod());

...
class SagePayCwServerModuleFrontController extends ModuleFrontController {
	public $ssl = true;
...
require_once 'SagePayCw/Entity/Transaction.php';
		...
		$adapter = SagePayCw_Util::getAuthorizationAdapter($transaction->getAuthorizationType());

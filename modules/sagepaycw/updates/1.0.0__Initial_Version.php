...
class SagePayCw_Migration_1_0_0 implements Customweb_Database_Migration_IScript{
	...
	public function execute(Customweb_Database_IDriver $driver) {
		...
		$driver->query("CREATE TABLE IF NOT EXISTS `" . _DB_PREFIX_ . "sagepaycw_customer_contexts` (
		...
		$driver->query("CREATE TABLE IF NOT EXISTS `sagepaycw_storage` (
		...
		$driver->query("CREATE TABLE IF NOT EXISTS `" . _DB_PREFIX_ . "sagepaycw_transactions` (

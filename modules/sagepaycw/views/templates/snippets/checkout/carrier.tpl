<div class="order_carrier_content sagepaycw-external-checkout-carrier-box box">
	...
	{if isset($virtual_cart) && $virtual_cart}
		<p>{lcw s='No shipping method needed.' mod='sagepaycw'}</p>
...
<p class="cart_navigation clearfix">
	{if isset($virtual_cart) && $virtual_cart || (isset($delivery_option_list) && !empty($delivery_option_list))}
		<button type="submit" name="processCarrier" id="shipping-method-submit-button" class="button btn btn-default standard-checkout button-medium">
			<span>
				{lcw s='Save Shipping Method' mod='sagepaycw'}
...
<!-- 
var sagepaycwJqueryLoaded = function() {
    jQuery('#shipping-method-submit-button').hide();
    jQuery('.sagepaycw-external-checkout-carrier-box').each(function() {
            var box = $(this);
...
if (document.readyState == "complete") { sagepaycwJqueryLoaded(); }
else if (window.addEventListener) { window.addEventListener("load", sagepaycwJqueryLoaded, false); }
else if (window.attachEvent) { window.attachEvent("onload", sagepaycwJqueryLoaded); }
else { window.onload = sagepaycwJqueryLoaded; }
-->
</script>
{/literal}
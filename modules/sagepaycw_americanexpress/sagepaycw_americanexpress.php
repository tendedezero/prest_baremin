 ...
 */
class SagePayCw_AmericanExpress extends PaymentModule implements SagePayCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'sagepaycw_americanexpress';
	public $paymentMethodName = 'americanexpress';
	public $paymentMethodDisplayName = 'American Express';

 ...
 */
class SagePayCw_CreditCard extends PaymentModule implements SagePayCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'sagepaycw_creditcard';
	public $paymentMethodName = 'creditcard';
	public $paymentMethodDisplayName = 'Credit Card';
...
require_once 'SagePayCw/Adapter/AbstractAdapter.php';
	...
	public function getFormFields(){
		...
		$fields = array(
			0 => array(
				'name' => 'CREDIT_CARD_BRANDS',
 				'label' => $this->l("Credit Card Brands"),
 				'desc' => $this->l("In case hidden authorization is used, the brand of the
						credit card is detected by the card number and the card number is
						validated
						accordingly. This setting enables the restriction of the
						allowed brands.
					"),
 				'default' => 'visa,mastercard,americanexpress,diners,jcb,maestro,debitmastercard,visaelectron,laser',
 				'multiple' => 'true',
 				'type' => 'select',
 				'options' => array(
					'query' => array(
						0 => array(
 						...
 						6 => array(
							'id' => 'debitmastercard',
 							'name' => $this->l("Debit MasterCard"),
 						),
 						7 => array(
							'id' => 'visaelectron',
 							'name' => $this->l("VISA Electron"),
 						),
 						8 => array(
							'id' => 'laser',
 							'name' => $this->l("Laser"),
 			...
 			10 => array(
				'name' => 'AUTHORIZATIONMETHOD',
 				...
 				'options' => array(
					'query' => array(
						0 => array(
							'id' => 'IframeAuthorization',
 							'name' => $this->l("IFrame Authorization (Server with IFrame)"),
 						),
 						1 => array(
...
$fields = array_merge($this->getFormFieldsInner(), $fields);
	...
	public function installMethodSpecificConfigurations(){
		self::loadClasses();
		$this->getConfigApi()->updateConfigurationValue('CREDIT_CARD_BRANDS', 'visa,mastercard,americanexpress,diners,jcb,maestro,debitmastercard,visaelectron,laser');
		...
		$this->getConfigApi()->updateConfigurationValue('AUTHORIZATIONMETHOD', 'IframeAuthorization');
	...
	public function uninstallMethodSpecificConfigurations(){
		self::loadClasses();
		$this->getConfigApi()->removeConfigurationValue('CREDIT_CARD_BRANDS');

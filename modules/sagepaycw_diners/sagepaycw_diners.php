 ...
 */
class SagePayCw_Diners extends PaymentModule implements SagePayCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'sagepaycw_diners';
	public $paymentMethodName = 'diners';
	public $paymentMethodDisplayName = 'Diners Club';

 ...
 */
class SagePayCw_LaserCard extends PaymentModule implements SagePayCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'sagepaycw_lasercard';
	public $paymentMethodName = 'lasercard';
	public $paymentMethodDisplayName = 'Laser Card';

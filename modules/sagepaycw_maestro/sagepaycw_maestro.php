 ...
 */
class SagePayCw_Maestro extends PaymentModule implements SagePayCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'sagepaycw_maestro';
	public $paymentMethodName = 'maestro';
	public $paymentMethodDisplayName = 'Maestro';

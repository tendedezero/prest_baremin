 ...
 */
class SagePayCw_MasterCard extends PaymentModule implements SagePayCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'sagepaycw_mastercard';
	public $paymentMethodName = 'mastercard';
	public $paymentMethodDisplayName = 'MasterCard';

 ...
 */
class SagePayCw_PayPal extends PaymentModule implements SagePayCw_IPaymentMethod {
	/**
	 *
 				...
 				'options' => array(
					'query' => array(
						0 => array(
 						...
 						2 => array(
							'id' => 'cancel',
 							'name' => $this->l("Cancel the transaction (the customer is
							forced to choose another payment method)
						"),
 						),
 					),
 					'name' => 'name',

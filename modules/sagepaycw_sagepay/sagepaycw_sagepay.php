 ...
 */
class SagePayCw_SagePay extends PaymentModule implements SagePayCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'sagepaycw_sagepay';
	public $paymentMethodName = 'sagepay';
	public $paymentMethodDisplayName = 'Sage Pay Payment';
			...
			0 => array(
 			...
 			3 => array(
				'name' => 'SELLER_PROTECTION',
 				'label' => $this->l("PayPal Seller Protection"),
 				'desc' => $this->l("PayPal may provide seller protection. In case PayPal
						grants no seller protection (address is not
						confirmed and the payer
						could not be verified), what should happend with the transaction?
					"),
 				'default' => 'uncertain',
 				'type' => 'select',
 				'options' => array(
					'query' => array(
						0 => array(
							'id' => 'accept',
 							'name' => $this->l("Accept the transaction"),
 						),
 						1 => array(
							'id' => 'uncertain',
 							'name' => $this->l("Mark the transaction as uncertain"),
 						),
 					),
 					'name' => 'name',
 					'id' => 'id',
				...
				'name' => 'AUTHORIZATIONMETHOD',
 				...
 				'options' => array(
					'query' => array(
						0 => array(
							'id' => 'PaymentPage',
 							'name' => $this->l("Payment Page (Server)"),
 						),
 						1 => array(
...
$fields = array_merge($this->getFormFieldsInner(), $fields);
	...
	public function installMethodSpecificConfigurations(){
		...
		$this->getConfigApi()->updateConfigurationValue('SELLER_PROTECTION', 'uncertain');
	...
	public function uninstallMethodSpecificConfigurations(){
		...
		$this->getConfigApi()->removeConfigurationValue('SELLER_PROTECTION');

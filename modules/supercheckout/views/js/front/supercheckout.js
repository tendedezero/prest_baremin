                    ...
                    if (extrasError) {
                        ...
                        if (jsonData['is_free_order']) {
                            ...
                            if ($('.sagepaycw-standard-redirection').is(':visible')) {
                                ...
                                window.location = $('#payment_methods_additional_container .payment-option-4_info_container form.sagepaycw-standard-redirection').attr('action')+ '&'+$('form.sagepaycw-standard-redirection').serialize();
                                return;
                            }

...
class ProductControllerCore extends ProductPresentingFrontControllerCore
{
    ...
    protected function assignPriceAndTax()
    {
        ...
        $product_price_without_tax = Product::getPriceStatic($this->product->id, false, null, 6);
        $product_price_with_tax = Tools::ps_round($product_price_with_tax, 2); 
	$product_price_without_tax = Tools::ps_round($product_price_without_tax, 2);
 	...
 	$product_price_exc = $this->product->getPrice(Product::$_taxCalculationMethod == PS_TAX_EXC, $id_product_attribute);
	...
	$product_full['price_tax_excluding'] =  $product_full['price_tax_exc'];

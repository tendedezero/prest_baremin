...
<div class="new-item">
	<div class="form-group">
		<button type="button" class="btn btn-default btn-lg button-new-item"><i class="icon-plus-sign"></i> {l s='Add item' mod='angarbanners'}</button>
	</div>
		...
		<form method="post" action="{$htmlitems.postAction|escape:'htmlall':'UTF-8'}" enctype="multipart/form-data" class="item-form defaultForm  form-horizontal">
			<div class="well">
				<div class="language item-field form-group">
					<label class="control-label col-lg-3">{l s='Language' mod='angarbanners'}</label>
					<div class="col-lg-7">
				...
				<div class="hook item-field form-group">
					<label class="control-label col-lg-3">{l s='Hook' mod='angarbanners'}</label>
					<div class="col-lg-7">
				...
				<div class="image item-field form-group">
					<label class="control-label col-lg-3">{l s='Image' mod='angarbanners'}</label>
					<div class="col-lg-7">
				...
				<div class="image_w item-field form-group">
					...
					<div class="col-lg-7">
						<div class="input-group fixed-width-lg">
							<span class="input-group-addon">{l s='px' mod='angarbanners'}</span>
				...
				<div class="url item-field form-group">
					<label class="control-label col-lg-3">{l s='URL' mod='angarbanners'}</label>
					<div class="col-lg-7">
				...
				<div class="target item-field form-group">
					<div class="col-lg-9 col-lg-offset-3">
						<div class="checkbox">
							<label class="control-label">
								{l s='Target blank' mod='angarbanners'}
				...
				<div class="html item-field form-group">
					<label class="control-label col-lg-3">{l s='HTML' mod='angarbanners'}</label>
					<div class="col-lg-7">
				...
				<div class="form-group">
					<div class="col-lg-7 col-lg-offset-3">
						<button type="button" class="btn btn-default button-new-item-cancel"><i class="icon-remove"></i> {l s='Cancel' mod='angarbanners'}</button>
						<button type="submit" name="newItem" class="btn btn-success button-save pull-right"><i class="icon-save"></i> {l s='Save' mod='angarbanners'}</button>
					</div>
				</div>
			</div>
		</form>

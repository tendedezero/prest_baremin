...
<div id="productCommentsBlock">
    <h3 class="h5 text-uppercase index_title"><span>{l s='Reviews' mod='productcomments'}</span></h3>
    <div class="tabs">
                    ...
                    {if isset($product) && $product}
                        <div class="product clearfix">
                            <div class="product_desc">
								<img src="{$productcomment_cover_image}" height="{$mediumSize.height}" width="{$mediumSize.width}" alt="{$product->name}" />

    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <figure>
		  ...
		  {else}
			<img class="js-modal-product-cover product-cover-modal" width="{$product.cover.large.width}" src="{$urls.img_url}en-default-large_default.jpg" alt="{$product.cover.legend}" title="{$product.cover.legend}" itemprop="image">
		  {/if}

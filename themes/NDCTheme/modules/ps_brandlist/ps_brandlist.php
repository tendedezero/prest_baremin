...
class Ps_Brandlist extends Module implements WidgetInterface
{
    ...
    public function install()
    {
        ...
        Configuration::updateValue('BRAND_LIST', 5);
    ...
    public function uninstall()
    {
        return parent::uninstall()
            ...
            && Configuration::deleteByName('BRAND_LIST');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitBlockBrands')) {
            ...
            $text_list = Tools::getValue('BRAND_LIST');
            ...
            if ('brand_text' === $type && !Validate::isUnsignedInt($text_nb)) {
                ...
                && Configuration::deleteByName('BRAND_LIST', $text_list);
                $this->_clearCache('*');
            }

...
function loadPayments() {
    ...
    var module_id = typeof query.id_module != 'undefined' ? query.id_module : '';
    var error_transaction_id = typeof query.error_transaction_id != 'undefined' ? query.error_transaction_id : '';
    $.ajax({
        type: 'POST',
        headers: {
            "cache-control": "no-cache"
        ...
        cache: false,
        dataType: "json",
        data: 'ajax=true' + params + '&method=loadPayment&token=' + prestashop.static_token + '&error_transaction_id='+error_transaction_id +'&id_module='+module_id,
        beforeSend: function() {
                ...
                if (!is_carrier_selected || !is_payment_selected) {
                    ...
                    if (extrasError) {
                        ...
                        if (jsonData['is_free_order']) {
                            ...
                            if ($('.sagepaycw-standard-redirection').is(':visible')) {
                                $('#velsof_payment_dialog .sagepaycw-standard-redirection').remove();
                                window.location = $('#payment_methods_additional_container .payment-option-5_info_container form.sagepaycw-standard-redirection').attr('action')+ '&'+$('form.sagepaycw-standard-redirection').serialize();
                                return;
                            }

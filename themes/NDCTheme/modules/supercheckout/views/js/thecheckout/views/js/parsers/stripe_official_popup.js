...
checkoutPaymentParser.stripe_official = {
  ...
  form: function (element, triggerElementName) {
    ...
    // TODO: stripe cannot be initialized multiple times (e.g. when payment window is closed and then opened again), so we need either ensure some kind of de-init
    // or make sure it's being initialized only once, as with previous, static-container method (i.e. move stripe form to static container and only then to move to popup)

    // TODO: temporarily disable this handling and use popup-mode

...
class whatsapp extends Module
{
    ...
    public function getContent()
    {
		...
		if (((bool)Tools::isSubmit('telekle')) == true) {
			...
			$pst = Tools::getValue('pst');
			$shareThis = Tools::getValue('shareThis');
			$shareMessage = Tools::getValue('shareMessage');
		
			if( Validate::isPhoneNumber($telefon) && Validate::isCountryName($shook) && Validate::isCountryName($pst) && Validate::isInt($shareThis) && Validate::isCleanHtml($shareMessage))
			{

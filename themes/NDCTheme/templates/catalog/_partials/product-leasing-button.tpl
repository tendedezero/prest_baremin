...
{if $quotation->id==''}
 <a  class="btn btn-primary add-to-cart"  href="{$add_to_quote_link}&nka=add&id_customer={$id_customer}">	
 {l s='Add New Quote' mod='nsquotation'} 	
 </a> 
{else}
<a  class="btn btn-primary add-to-cart"  href="{$add_to_quote_link}&nka=add&id_ns_quotation={$quotation->id}&id_customer={$quotation->id_customer}">	

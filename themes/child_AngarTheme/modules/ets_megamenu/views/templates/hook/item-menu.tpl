            ...
            <span class="mm_menu_name mm_menu_toggle">
                <span class="mm_menu_content_title">
                    {if $menu.menu_img_link}
                        <img class="lazymenu" data-src="{$menu.menu_img_link|escape:'html':'UTF-8'}" title="" alt="" width="20" />
    ...
    {else}
        <div class="mm_menus_li_content">
            <span class="mm_menu_name mm_menu_toggle">
                <span class="mm_menu_content_title">
                    {if $menu.menu_img_link}
                        <img src="/img/pixel.gif" class="lazymenu" data-src="{$menu.menu_img_link|escape:'html':'UTF-8'}" title="" alt="" width="20" />
                    {elseif $menu.menu_icon}
                        <i class="fa {$menu.menu_icon|escape:'html':'UTF-8'}"></i>
                    {/if}
                    {$menu.title|escape:'html':'UTF-8'}

 ...
 *       		   	    	 		 
 */
class AdminSagePayCwRefundController extends AdminController
{
	public function __construct() {
		$this->className = 'AdminSagePayCwRefundController';
		parent::__construct();
		$this->context->smarty->addTemplateDir($this->getTemplatePath());
		$this->tpl_folder = 'sagepaycw_refund/';
		$this->bootstrap = true;
	}
	...
	public function initContent()
	{
		...
		$data = $_GET;
		$transaction = current(SagePayCw_Entity_Transaction::getTransactionsByOrderId((int)$data['id_order']));
		...
		$vars['refundAmount'] = SagePayCw::getRefundAmount($data);

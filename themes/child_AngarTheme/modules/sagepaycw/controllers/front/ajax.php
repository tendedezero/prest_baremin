...
class SagePayCwAjaxModuleFrontController extends ModuleFrontController {
	public $ssl = true;
...
require_once 'SagePayCw/Entity/Transaction.php';
		...
		$adapter = SagePayCw_Util::getShopAdapterByPaymentAdapter(SagePayCw_Util::getAuthorizationAdapterByContext($orderContext));

 ...
 *
 */
class SagePayCwIframeModuleFrontController extends ModuleFrontController {
	public $ssl = true;
...
require_once 'SagePayCw/Adapter/IframeAdapter.php';
		...
		$wrapper = SagePayCw_Util::getShopAdapterByPaymentAdapter(
				SagePayCw_Util::getAuthorizationAdapter($transaction->getTransactionObject()->getAuthorizationMethod()));

		if (!($wrapper instanceof SagePayCw_Adapter_IframeAdapter)) {
			throw new Exception("Expect 'SagePayCw_Adapter_IframeAdapter'.");
		}
		...
		$this->setTemplate('module:sagepaycw/views/templates/front/iframe.tpl');
	}
}

 ...
 *
 */
class SagePayCw_Adapter_PaymentPageAdapter extends SagePayCw_Adapter_AbstractAdapter {
	...
	protected function preparePaymentFormPane() {
		...
		if ($this->visibleFormFields !== null && count($this->visibleFormFields) > 0) {
			...
			$this->formActionUrl = $link->getModuleLink('sagepaycw', 'redirection', $parameters, true);
		}
		else {
			if ($this->getTransaction() !== null) {

 ...
 */
final class SagePayCw_LayoutController extends ModuleFrontController {
	...
	public function initContent(){
		...
		$this->addCSS(_MODULE_DIR_ . 'sagepaycw/css/style.css');
		...
		$this->setTemplate('module:sagepaycw/views/templates/front/default.tpl');
	}

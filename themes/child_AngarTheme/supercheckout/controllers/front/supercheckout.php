...
//                return $response;
            ...
            } else if ($continue == 1 && isset($posted_data['shipping_address_value']) && $posted_data['shipping_address_value'] == 0 && isset($posted_data['shipping_address_id'])) {
                $id_delivery_address = $posted_data['shipping_address_id'];
            ...
            } else if ($continue == 1 && !isset($posted_data['use_for_invoice']) && isset($posted_data['payment_address_value']) && $posted_data['payment_address_value'] == 0 && isset($posted_data['payment_address_id'])) { // Code added by Anshul to update the invoice address
                $id_invoice_address = $posted_data['payment_address_id'];

    ...
    {if $customer.addresses}
        ...
        <div id="shipping-existing" class="styled-select">
            ...
            <!-- Start: Code added by Anshul for adding update & remove address -->
                        <div id="kb_delivery_update_block">
                        <span id="delivery_address_edit" class="kb_edit_btn" onclick="updateAddressForm('delivery');">{l s='Update Address' mod='supercheckout'}</span>
                        <span id="delivery_address_delete" class="kb_delete_btn" onclick="deleteAddressForm('delivery');">{l s='Remove Address' mod='supercheckout'}</span>
                        </div>

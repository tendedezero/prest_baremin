...
vertical-align: top;
    ...
    #supercheckout-fieldset .rectangle-list a:before {
        ...
        background: #{$settings['customizer']['button_color']} !important;
        height: 2em;
        width: 2em;
        color: #{$settings['customizer']['button_text_color']} !important;
        line-height: 2em;
...
{*Added by Anshul to change the progressive loader*}
    ...
    <form id="velsof_supercheckout_form" action="{$supercheckout_url}" method="POST" onsubmit=" return isPressedEnter(this)" enctype="multipart/form-data">
        {*Added by Anshul to change the progressive loader*}
    ...
    {*Added by Anshul to change the progressive loader*}
    <div class="container" id="supercheckout_order_progress_bar">
        <div class="row">
            <div class="col-md-12">
                <h3 class="progress-title">Loading....</h3>
                ...
                <div class="supercheckout-blocks" data-column="{$settings['design']['confirm'][$layout_name]['column']|intval}" data-row="{$settings['design']['confirm'][$layout_name]['row']|intval}" data-column-inside="{$settings['design']['confirm'][$layout_name]['column-inside']|intval}" >
                    ...
                    <div id="placeorderButton">
                        ...
                        <div id="buttonWithProgres" style="width:206px;">
                            <div  id="supercheckout_continue_shopping" class="orangebutton" >
